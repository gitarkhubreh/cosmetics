...
const products: Product[] = [
  { id: 1, name: 'Miracle C Cream (vitamin C+ vitamin B3+ vitamin E)', price: 15, image: '/vi.jpg', sale: true },
  { id: 2, name: 'Prime & Purifier', price: 30, image: '/p1.jpg', sale: true },
  { id: 3, name: 'Instant Revival Facial (Glass-skin in 5 minutes)', price: 40, image: '/re.webp', sale: false },
  { id: 4, name: 'Skin Brightening Soap (with kojic acid)', price: 20, image: '/ko.jpg', sale: true },
  { id: 5, name: 'Glow Enchanting Moisturizer', price: 35, image: '/in.webp', sale: true },
  { id: 6, name: 'Tea Tree Toner', price: 30, image: '/to.jpg', sale: true },
  { id: 7, name: 'Whitening Cleanser Mousse—(alpha arbutin+glycolic acid+aloevera)', price: 20, image: '/wc.webp', sale: false },
  { id: 8, name: 'Anti Frizz Hair Serum', price: 20, image: '/af.jpg', sale: true },
  { id: 9, name: 'Whitening Booster Serum—(alpha arbutin+hyaluronic acid)', price: 70, image: '/wi.jpg', sale: true },
  { id: 10, name: 'Smooth Scrubby', price: 20, image: '/sm.webp', sale: true },
  { id: 11, name: 'Luminous hydraGel— (niacinamide+hyaluronic acid+witch hazel)', price: 20, image: '/smo.webp', sale: true },
  { id: 12, name: 'Lip Lightening Cream', price: 20, image: '/ba.jpg', sale: true },
];
...
export default function Skincare() {
  ...
  return (
    <div className="container mx-auto p-6 pb-12 bg-gray-300 mt-20" id="shop">
      <h1 className="text-5xl font-bold text-center mb-6 text-pink-500">SkinCare</h1>
